...
data class LlmMessageDto(
    ...
    val attachments: List<LlmAttachmentDto> = emptyList(),
...
@Serializable
data class LlmToolDefinitionDto(
    val type: String = "function",
    val function: LlmToolFunctionDto
)
...
@Serializable
data class LlmToolCallFunctionDto(
    val name: String,
